...
#import "UIImage+Ionicons.h"

@implementation UIImage (Ionicons)
/**
...
+(UIImage*)imageWithIonicIcon:(NSString*)identifier backgroundColor:(UIColor*)bgColor iconColor:(UIColor*)iconColor iconScale:(CGFloat)scale andSize:(CGSize)size{
    ...
    [iconColor setFill];
    [textContent drawInRect: textRect withFont: [UIFont fontWithName:@"Ionicons" size:(float)((int)fontSize)] lineBreakMode: NSLineBreakByWordWrapping alignment: NSTextAlignmentCenter];
