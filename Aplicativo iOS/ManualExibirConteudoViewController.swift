//
//  ManualExibirConteudoViewController.swift
//  Pintura a Jato
//
...
class ManualExibirConteudoViewController : UIViewController {
    
    @IBOutlet weak var webView: UIWebView!
    var contexto: ContextoManuaisExibir?
    
    func defineContexto(_ contexto: ContextoManuaisExibir?) {
